  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 border-b border-white/10 pb-12">
        <div className="flex flex-col gap-2">
          <div className="flex items-center">
            ...
            <div className="text-white text-[10px] font-bold tracking-tight leading-tight">
              <div>NCCF</div>
              <div className="text-primary">CROSS RIVER</div>
              <div className="text-primary">STATE CHAPTER</div>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-2 sm:gap-6">
          ...
          <ul className="flex flex-col gap-3">
            ...
            <li><a className="hover:text-primary transition-colors" href="#vision">Vision &amp; Mission</a></li>
            <li><a className="hover:text-primary transition-colors" href="#minister">Minister</a></li>
            <li><a className="hover:text-primary transition-colors" href="#schedule">Schedule</a></li>
            <li>
              <button
                type="button"
        ...
        <div className="flex flex-col gap-2 sm:gap-6">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-primary text-sm mb-2 block">location_on</span>
              <span className="text-sm">State Secretariat, Calabar, CRS</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-primary text-sm mb-2 block">mail</span>
              <span className="text-sm">info@nccfcrossriver.org</span>
            </div>
          </div>
          <div className="flex flex-col gap-1 mt-2">
            <p className="text-xs tracking-[0.1em] text-primary/70 font-semibold">
              Follow us @NCCFCROSSRIVER
            </p>
            <div className="flex gap-2">
              <a
                className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary transition-all"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  className="w-5 h-5 fill-[#708882] hover:fill-white transition-colors"
                >
      ...
      <div className="max-w-7xl mx-auto pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium tracking-[0.2em]">
        <p className="text-[#708882] text-center md:text-left">© {new Date().getFullYear()} NCCF Cross River State. All rights reserved.</p>
        <p className="text-[#708882] text-center md:text-left">Rural Rugged Evangelism...</p>
      </div>
    </footer>
  );
};

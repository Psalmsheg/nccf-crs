    ...
    >
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-8">
          ...
          <h1 className="text-[#111813] text-5xl lg:text-7xl font-black tracking-tight animate-fade-in-up animate-delay-100">NCCF Cross River State <span className="text-primary block decoration-primary/30">Conference 2026</span></h1>
        ...
        <div className="relative animate-fade-in-up animate-delay-500">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
            <img alt="Conference Atmosphere" className="w-full object-cover" data-alt="Group of people worshiping at a christian conference" src="NCCF CRS Conference.jpeg"/>
          </div>
        </div>
      </div>
    </section>

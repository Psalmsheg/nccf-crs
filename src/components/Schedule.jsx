      ...
      sessions: [
        ...
        },
        {
          ...
          items: [
            ...
            { time: '5:40PM – 6:00PM', program: 'Prayer', minister: '—' },
            { time: '6:00PM', program: 'Announcement', minister: '—' },
            { time: '6:00PM – 8:00PM', program: 'Rest / Dinner', minister: '—' },
          ],
        },
        {
          ...
          items: [
            ...
            { time: '11:00PM', program: 'Announcement', minister: '—' },
      ...
      sessions: [
        {
          ...
          items: [
            ...
            { time: '11:40AM – 1:30PM', program: 'Brunch / Rest', minister: '—' },
          ],
        },
        {
          ...
          items: [
            ...
            { time: '8:20PM', program: 'Announcement and Benediction', minister: '—' },
            {
              time: '10:00PM',
      ...
      sessions: [
        {
          ...
          items: [
            ...
            { time: '8:50AM – 8:55AM', program: 'Prayer of Confession', minister: '—' },

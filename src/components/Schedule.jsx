      ...
      sessions: [
        {
          ...
          items: [
            ...
            { time: '8:40AM – 10:00AM', program: 'Missionaries in the Marketplace', minister: 'Pastor Victor Enwereuzor' },
            {
            ...
            { time: '11:40AM – 1:00PM', program: 'Brunch / Rest', minister: 'Camp Commandant' },
            { time: '1:00PM – 2:00PM', program: 'Mission Awareness', minister: 'Harvest in All Nations' },
          ],
        },
        {
          title: 'Saturday Afternoon Session',
          items: [
            { time: '3:00PM – 6:00PM', program: 'Alumni Reunion', minister: 'Pastor Joshua Olalekan' },
            { time: '6:00PM – 6:20PM', program: 'Praise and Worship', minister: 'Fountain Choir' },
            { time: '6:20PM – 7:20PM', program: 'Health Matters', minister: 'Pastor Adesanya Emmanuel' },
            // {
            //   time: '6:20PM – 8:20PM',
            //   program: 'Missionaries in the Marketplace',
            //   minister: 'Pastor Victor Enwereuzor',
            // },
            { time: '7:20PM - 7:30PM', program: 'Announcement and Benediction', minister: 'Zonal Delegate' },
            {
              time: '10:00PM',
